...
bool   enableAnimation[4];
static rive::LinearAnimationInstance* animationInstance[4];
...
static void setupScreen(uint32_t* buffer)
{
    ...
    Eo* animationCheck1 = elm_check_add(box);
    elm_object_text_set(animationCheck1, "idle");
    evas_object_smart_callback_add(animationCheck1, "changed", animationChangedCb, (void*)0);
    elm_box_pack_end(box, animationCheck1);
    evas_object_show(animationCheck1);

    Eo* animationCheck2 = elm_check_add(box);
    elm_object_text_set(animationCheck2, "bouncing");
    evas_object_smart_callback_add(animationCheck2, "changed", animationChangedCb, (void*)1);
    elm_box_pack_end(box, animationCheck2);
    evas_object_show(animationCheck2);

    Eo* animationCheck3 = elm_check_add(box);
    elm_object_text_set(animationCheck3, "windshield_wipers");
    evas_object_smart_callback_add(animationCheck3, "changed", animationChangedCb, (void*)2);
    elm_box_pack_end(box, animationCheck3);
    evas_object_show(animationCheck3);

    Eo* animationCheck4 = elm_check_add(box);
    elm_object_text_set(animationCheck4, "broken");
    evas_object_smart_callback_add(animationCheck4, "changed", animationChangedCb, (void*)3);
    elm_box_pack_end(box, animationCheck4);
    evas_object_show(animationCheck4);
